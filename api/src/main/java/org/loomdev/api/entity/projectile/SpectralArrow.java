...
public interface SpectralArrow extends AbstractArrow {
    ...
    /**
     * Gets the amount of ticks the glowing {@link org.loomdev.api.entity.effect.StatusEffect} will be applied for.
     *
    ...
    /**
     * Sets the amount of ticks the glowing {@link org.loomdev.api.entity.effect.StatusEffect} will be applied for.

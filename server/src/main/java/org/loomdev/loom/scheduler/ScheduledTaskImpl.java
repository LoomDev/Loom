...
public class ScheduledTaskImpl extends FutureTask<Void> implements ScheduledTask {
    ...
    public ScheduledTaskImpl(@NotNull Plugin plugin, @NotNull Runnable task, boolean sync, long delay, long period) {
        super(task, null);
    ...
    static class BuilderImpl implements Builder {
        ...
        @Override
        @NotNull
        public ScheduledTask complete(@NotNull Plugin plugin) {

...
public abstract class HangingEntityImpl extends EntityImpl implements HangingEntity {

    public HangingEntityImpl(net.minecraft.world.entity.decoration.HangingEntity entity) {
        super(entity);
    }
